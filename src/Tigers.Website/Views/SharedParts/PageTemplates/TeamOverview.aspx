...
<asp:Content ID="Content1" ContentPlaceHolderID="TextContent" runat="server">
	...
	<div class="playerPosition">
	    <p>Preferred Position:</p><%= Html.DisplayContent(m => m.PreferredPosition).WrapIn("p", new { @class = "position1" }) %>
	    <p>Secondary Position:</p><%= Html.DisplayContent(m => m.SecondaryPosition).WrapIn("p", new { @class = "position2" }) %>
	</div>
</asp:Content>
